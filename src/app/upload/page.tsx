    ...
    <UploadManagerProvider>
      <div className="mx-auto w-full max-w-5xl space-y-8">
        <header className="text-center">
          ...
          <h1 className="mt-2 font-[family-name:var(--font-display)] text-3xl font-semibold tracking-tight text-text-primary">
            Import data
          </h1>
          <p className="mx-auto mt-4 max-w-xl text-sm leading-7 text-text-tertiary [text-wrap:pretty]">
