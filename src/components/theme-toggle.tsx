...
export function ThemeToggle() {
  ...
  if (!mounted) {
    return <div className="h-9 w-9 rounded-full bg-bg-muted animate-pulse" />;
  }
  ...
  return (
    ...
    >
      ...
      <svg
        className={`h-4 w-4 transition-transform duration-300 ${isDark ? "-rotate-90 scale-0" : "rotate-0 scale-100"}`}
        fill="none"
        viewBox="0 0 24 24"
        stroke="currentColor"
        strokeWidth={2}
